// Per-viewport probe for step L (提出方案) — iPhone-15-Pro
// Run: node audit/cycles/2026-04-30/probes/step-l-iPhone-15-Pro.js
const { run } = require('./step-l-shared');
const VP = { name: 'iPhone-15-Pro', width: 0, height: 0, isMobile: false };
const map = {
...
run(map['iPhone-15-Pro']).then(()=>process.exit(0)).catch(e=>{console.error(e);process.exit(1);});
