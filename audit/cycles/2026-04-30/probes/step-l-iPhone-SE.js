// Per-viewport probe for step L (提出方案) — iPhone-SE
// Run: node audit/cycles/2026-04-30/probes/step-l-iPhone-SE.js
const { run } = require('./step-l-shared');
const VP = { name: 'iPhone-SE', width: 0, height: 0, isMobile: false };
const map = {
...
run(map['iPhone-SE']).then(()=>process.exit(0)).catch(e=>{console.error(e);process.exit(1);});
