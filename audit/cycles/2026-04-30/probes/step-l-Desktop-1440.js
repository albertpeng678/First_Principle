// Per-viewport probe for step L (提出方案) — Desktop-1440
// Run: node audit/cycles/2026-04-30/probes/step-l-Desktop-1440.js
const { run } = require('./step-l-shared');
const VP = { name: 'Desktop-1440', width: 0, height: 0, isMobile: false };
const map = {
...
run(map['Desktop-1440']).then(()=>process.exit(0)).catch(e=>{console.error(e);process.exit(1);});
