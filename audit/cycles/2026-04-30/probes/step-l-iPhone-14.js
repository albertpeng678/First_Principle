// Per-viewport probe for step L (提出方案) — iPhone-14
// Run: node audit/cycles/2026-04-30/probes/step-l-iPhone-14.js
const { run } = require('./step-l-shared');
const VP = { name: 'iPhone-14', width: 0, height: 0, isMobile: false };
const map = {
...
run(map['iPhone-14']).then(()=>process.exit(0)).catch(e=>{console.error(e);process.exit(1);});
