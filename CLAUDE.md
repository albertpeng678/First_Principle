...
> **Last updated:** 2026-05-03（06 NSM Step 1 放行 / 紫色全清 / 下一張 07）
...
| 07 | 待畫（NEXT）| `docs/superpowers/specs/mockups/2026-05-02-frontend-rewrite/07-nsm-step-2.html` | NSM Step 2（4-dim 動態 label）|
