...
module.exports = defineConfig({
  ...
  projects: [
    ...
    {
      name: 'e2e-desktop',
      testMatch: /(circles-gate|circles-gate-await-patch-real|circles-draft-retry-real|circles-phase3-restore|circles-phase3-restore-real|offcanvas-delete|offcanvas-delete-invalidates-recent-sessions|phase2-ui-fix|circles-phase2-qchip-sse-rerender|capture-t4-qchip-sse|circles-delete-rollback-real|persist-retry-browser-real|critical-path-full-flow|auth-flow-real|nsm-full-flow|nsm-evaluate-checkpoint-real|nsm-evaluate-shape-roundtrip|circles-back-nav-lock|bug3-spinner-stuck-reproduce|bug3-spinner-deep-investigation|circles-fresh-form-no-ghost|circles-fe-gate-stale-state|nsm-hint-ui-flow|nsm-gate-result-ui-display|nsm-impact-removal-fresh-session|nsm-impact-backward-compat|nsm-freq-label-by-type|audit-nsm-director-walk-2026-05-17|apiFetch-401-refresh-retry|audit-nsm-conversion-funnel-instrumentation|nsm-evaluator-error-clears-spinner|circles-phase2-evaluator-error-shown|circles-gate-warn-icon-color|nsm-question-switch-resets-draft|nsm-dim-card-hint-row-position|nsm-step1-card-click-no-session|wave1-b13-prompt-regression-smoke|wave1-b6-circles-phase1-to-gate-real-flow|wave1-fct1\.3-circles-gate-backoff-real-flow|wave1-fct1\.4-nsm-gate-error-i18n)\.spec\.js$/,
