...
module.exports = defineConfig({
  ...
  projects: [
    ...
    {
      name: 'e2e-desktop',
      testMatch: /(circles-gate|circles-gate-await-patch-real|circles-phase3-restore|circles-phase3-restore-real|offcanvas-delete|phase2-ui-fix|circles-phase2-qchip-sse-rerender|capture-t4-qchip-sse|circles-delete-rollback-real|persist-retry-browser-real|critical-path-full-flow|auth-flow-real|nsm-full-flow|circles-back-nav-lock)\.spec\.js$/,
