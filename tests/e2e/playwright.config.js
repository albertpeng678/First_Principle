...
module.exports = defineConfig({
  ...
  projects: [
    ...
    {
      name: 'e2e-desktop',
      testMatch: /(circles-gate|circles-phase3-restore|circles-phase3-restore-real|offcanvas-delete|phase2-ui-fix|circles-delete-rollback-real|persist-retry-browser-real|critical-path-full-flow|auth-flow-real|nsm-full-flow)\.spec\.js$/,
