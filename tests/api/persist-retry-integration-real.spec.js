...
//
// Real integration test proving that the route handlers wrapped by persistRetry
// actually persist data end-to-end.
//
...
test.describe('persistRetry route integration — real API', () => {
