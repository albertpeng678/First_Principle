// Capture mockup 13 (Phase 4 Final Report) frame-by-frame across 3 sections × 3 viewports.
// Output: audit/png-mockup-13/section-{A,B,C}-{mobile,tablet,desktop}.png — 9 PNGs total.
...
const MOCKUP_PATH = path.resolve(
  __dirname,
  '../../docs/superpowers/specs/mockups/2026-05-02-frontend-rewrite/13-phase-4-final.html'
);
const OUT_DIR = path.resolve(__dirname, '../../audit/png-mockup-13');
...
test('capture mockup 13 — 3 sections × 3 viewports = 9 PNGs', async ({ page }) => {
